...
import { useCreateKategoriMutation } from '@/hooks/api/kategoriSliceAPI';

export default function FormTambahKategori({ onCancel, onSuccess }) {
    const [createKategori, { isLoading, isError, error }] = useCreateKategoriMutation();
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            const namaKategoriSuccess = namaKategori;
            ...
            if (onSuccess) {
                onSuccess(result, {
                    namaKategori: namaKategoriSuccess,
                });
            }
        } catch (err) {
